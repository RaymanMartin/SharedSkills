---
name: obsidian-skills-integrate
description: 'Obsidian官方知识管理技能集（Obsidian CEO kepano开源），提供Obsidian专属Markdown语法处理、JSON Canvas画布操作、Bases数据库管理能力。支持双向链接Wikilinks、内容嵌入Embed、标注块Callouts、前置元数据YAML Properties等Obsidian特有功能。触发关键词：Obsidian笔记操作、知识库管理、双向链接、Canvas画布、Obsidian Bases。'
---
